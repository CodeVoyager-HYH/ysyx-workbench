...
decode u_decode(
	...
	.axi4_mem_i_io_master_rdata	(axi4_mem_o_io_master_rdata	),
...
regE u_regE(
    .clk                   	    (clock                   ),
    .rst                   	    (rst_o_reset             ),
    .ctrl_i_regE_stall          (ctrl_o_regE_stall       ),
...
regM u_regM(
    .clk                	    (clock                   ),
    .rst                	    (rst_o_reset             ),
    .ctrl_i_regM_stall          (ctrl_o_regM_stall       ),
    .execute_i_valE     	    (execute_o_valE          ),
    .execute_i_pre_pc   	    (execute_o_pre_pc        ),
...
wire		memory_o_io_master_arvalid;
wire [2:0]	memory_o_io_master_arsize;
...
memory u_memory(
	...
	.memory_o_io_master_arvalid	(memory_o_io_master_arvalid	),
	.memory_o_io_master_arsize	(memory_o_io_master_arsize	),
    .memory_o_valM 	            (memory_o_valM              )
);
//

wire [31:0] axi4_mem_o_io_master_rdata;
axi4_mem u_axi4_mem(
    .rst                            (rst_o_reset                ),

    .axi4_mem_i_io_master_wready	(io_master_wready    		),
	...
	.axi4_mem_i_io_master_awready	(io_master_awready   		),
	...
	.regM_i_valE					(regM_o_valE				),
	.axi4_mem_i_io_master_arready	(io_master_arready			),
	.memory_i_io_master_arvalid		(memory_o_io_master_arvalid	),
	.memory_i_io_master_arsize		(memory_o_io_master_arsize	),
	.axi4_mem_o_io_master_araddr	(io_master_araddr			),
	.axi4_mem_o_io_master_arvalid	(io_master_arvalid			),
	.axi4_mem_o_io_master_arsize	(io_master_arsize			),

	.axi4_mem_i_io_master_rvalid	(io_master_rvalid			),
	.axi4_mem_i_io_master_rdata		(io_master_rdata			),
	.regM_i_mem_rw					(regM_o_mem_rw				),
	.memory_i_valM					(memory_o_valM				),
	.axi4_mem_o_io_master_rready	(io_master_rready			),
	.axi4_mem_o_io_master_rdata		(axi4_mem_o_io_master_rdata	)
);
...
wire [3:0]regW_o_mem_rw;
regW u_regW(
    .clk                			(clock              		),
    .rst                			(rst_o_reset        		),
    .ctrl_i_regW_stall              (ctrl_o_regW_stall          ),
    .regM_i_wb_reg_wen  			(regM_o_wb_reg_wen  		),
    .regM_i_wb_rd       			(regM_o_wb_rd       		),
...
assign commit        = (ctrl_o_regW_stall)? 1'b0 : regW_o_commit;
...
wire soc_stall;
ctrl u_ctrl(
    .regM_o_mem_rw              (regW_o_mem_rw),

    .soc_stall(soc_stall),

    .execute_i_need_jump 		(execute_o_need_jump  ),
    .ctrl_i_io_master_wready    (io_master_wready     ),
	.ctrl_i_io_master_arready	(io_master_arready	  ),
