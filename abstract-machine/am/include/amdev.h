...
AM_DEVREG( 9, GPU_CONFIG,   RD, bool present, has_accel; int width, height, vmemsz);//显示控制器的信息，读出屏幕的大小信息
AM_DEVREG(10, GPU_STATUS,   RD, bool ready);
AM_DEVREG(11, GPU_FBDRAW,   WR, int x, y; void *pixels; int w, h; bool sync);//写入绘图信息，向屏幕(x,y)处回执(w*h)的矩形图像,行优先存在pixels中，当sync为true时把缓冲的内容同步到屏幕上
